...
export default function Vision() {
  ...
  const menuText = [
    ...
    'We source raw materials of the highest quality, and are equipped for the custom manufacture and engineering of all Fitout & FF&E items in our own facilities. From light fixtures and ceiling work, to drapery, furniture, metal and glass work, all the way down to carpets, rugs, and flooring, everything is handled in-house.',
    'We navigate international regulations and provide logistical support to ensure seamless transportation. We have over 20 years of experience with managing the intricacies of transporting Fitout & FF&E items internationally, and your experience will be hassle-free.',
